...
## Ziel
Das DSFinV-K Cash Point Closing bildet den Kassenabschluss fuer einen Zeitraum ab.
Der Abschluss wird beim Submit eines POS Closing Entry erstellt.
...
- DSFinV-K VAT Rate und DSFinV-K Payment Type Mapping gepflegt
