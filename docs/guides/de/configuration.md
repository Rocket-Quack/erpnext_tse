...
- Ablaufdiagramme: `docs/guides/de/process_diagram.md`
- Taegliche Nutzung: `docs/guides/de/usage.md`
- Recovery: `docs/guides/de/recovery_tse_security_device.md`, `docs/guides/de/recovery_tse_client.md`, `docs/guides/de/recovery_tse_transaction.md`
